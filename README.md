...
| 代码库上手向导 | `codebase-onboarding-guide` | 接手没人懂的老项目时，读源码、理调用链、画模块边界，帮你看懂这个项目、半天上手陌生代码库。 |
...
| 项目交付护航官 | `ops-project-delivery-shepherd` | 把项目从立项推到交付，做关键路径排程、风险与依赖识别、干系人对齐，专盯跨部门掉球和延期预警。 |
